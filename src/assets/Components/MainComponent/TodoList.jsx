export default function TodoList({ tasks, onDeleteTask, onEditTask, onFilterTasks }) {
  return (
    <div className="mb-4 w-full px-2 sm:w-1/2 md:w-1/4">
      <div className="rounded-lg bg-blue-500 p-4">
        <div className="mb-2 flex items-center justify-between">
          ...
          {/* Filter button svg */}
          <svg
            onClick={onFilterTasks} // Call the filter function
            ...
            <div key={index} className="mb-4 rounded-lg bg-gray-800 p-4">
              <div className="flex justify-between">
                ...
                <div className="flex gap-2">
                  <svg
                    onClick={() => onDeleteTask(task.id, "todo")}
                    xmlns="http://www.w3.org/2000/svg"
                    width="24"
                    height="24"
                    viewBox="0 0 24 24"
